  ...
  const searchBuses = useCallback(() => {
    if (fromCity && toCity) {
      ...
      setTimeout(() => {
        ...
        const foundBuses = DUMMY_BUSES.filter(
          (bus) =>
    ...
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200 font-sans">
      <header className="bg-white dark:bg-slate-800 shadow-md p-4 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <img
            src="https://www.rsrtconline.rajasthan.gov.in/Images/logo.png"
            alt="RSRTC Logo"
        ...
        <div className="flex items-center gap-2 text-sm sm:text-base">
          <button
            className={`p-1 rounded ${
              lang === Language.ENGLISH ? "font-bold text-indigo-600" : ""
            }`}
          ...
          <button
            className={`p-1 rounded ${
              lang === Language.HINDI ? "font-bold text-indigo-600" : ""
            }`}
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6">
            <button
              ...
              disabled={
                !fromCity || !toCity || status === "processing" || isListening
              }
